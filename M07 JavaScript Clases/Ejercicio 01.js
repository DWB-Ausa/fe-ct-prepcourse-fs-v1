...
function crearUsuario() {
   ...
   class Usuario {
      ...
      //Metodo va fuera del constructor, en este caso el metodo es 'saludar'
      saludar(){
         return 'Hola, mi nombre es ' + this.nombre;
      }
   }
   //retorno solo la class
   return Usuario;
...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function(){
      /* divido la cadena en caracteres usando 'split'
      invierto el array resultante con .reverse(), 
      y luego uno los caracteres INVERTIDOS de nuevo en una cadena con join('') */
      var palabraInvertida = this.split('').reverse().join('');
